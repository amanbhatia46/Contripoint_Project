...
class AllotBudget(unittest.TestCase):
    ...
    def Allotment_Type(self):
        ...
        try:
            ...
            #Allot Budget
            self.driver.find_element(By.XPATH,'//span[text()=" Allot Budget "]').click()
    ...
    def Members_Type(self):
        ...
        try:
            ...
            self.driver.find_element(By.XPATH,'//mat-select[@formcontrolname="member_type"]').click()
            

            #Upload Employee Excel
            self.driver.find_element(By.XPATH,'//span[text()=" Upload Employee Excel "]').click()
    ...
    def SplitAmount(self):
        ...
        """
        try:
            self.driver.find_element(By.XPATH,'//input[@type="number"]').send_keys("600")
            
            print("\n 10 - AllotBudget(₹)= 600")

            #ConversionRatio
            print("Conversion Ratio= " + (WebDriverWait(self.driver, 20).until(EC.visibility_of_element_located((By.XPATH,'//input[@ng-reflect-name="conversionRatio"]'))).text))

            #Split Amount
            self.driver.find_element(By.XPATH,'//button[text()="Split Amount"]').click()
    ...
    def ActionButton(self):
        ...
        try:
            #View Button
            self.driver.find_element(By.XPATH,'//mat-icon[text()="arrow_drop_down"]').click()
