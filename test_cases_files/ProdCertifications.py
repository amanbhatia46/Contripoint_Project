...
class CAuth(unittest.TestCase):
    ...
    def Date_Of_Completion(self):
        ...
        try:
            ...
            datefield = self.driver.find_element(By.XPATH,'//button[@aria-label="Open calendar"]').click()
            datefield = self.driver.find_element(By.CSS_SELECTOR, ".mat-calendar-body-today").click()
    ...
    def Uploading_Attachment(self):
        ...
        try:
            ...
            self.driver.find_element(By.XPATH,'//label[text()=" Upload certificate"]').click()
            time.sleep(5)
    ...
    def Technology(self):
        ...
        try:
            #Technology-
            self.driver.find_element(By.XPATH,'//div//span[text()="Select Technology"]').click()
    ...
    def Submit(self):
        ...
        try:
            #SUBMIT
            element = self.driver.find_element(By.XPATH, '//button[contains(text(),"SUBMIT")]')
